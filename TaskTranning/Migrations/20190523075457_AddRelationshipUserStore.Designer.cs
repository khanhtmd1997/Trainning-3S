...
namespace TaskTranning.Migrations
{
    ...
    [Migration("20190523075457_AddRelationshipUserStore")]
    partial class AddRelationshipUserStore
    {
            ...
            modelBuilder.Entity("TaskTranning.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            PassWord = "10000:+RDp9ZcY5PnYQysYE/mQpcKh4mz3N+N8efSTBOcy6d3aMady",
                            Phone = 364606406,
                            Picture = "logo.jpg",
                            StoreId = 1
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            PassWord = "10000:EnPj7vB1c76cXyF8lroa7d/pn+B4hyZ62JXcFDLNj5P2czWR",
                            Phone = 364606406,
                            Picture = "logo.jpg",
                            StoreId = 2
                        });
