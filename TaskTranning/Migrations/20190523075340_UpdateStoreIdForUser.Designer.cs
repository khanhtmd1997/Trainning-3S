...
namespace TaskTranning.Migrations
{
    ...
    [Migration("20190523075340_UpdateStoreIdForUser")]
    partial class UpdateStoreIdForUser
    {
            ...
            modelBuilder.Entity("TaskTranning.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            PassWord = "10000:8J8f7DVofeutqUVos3G0sDw4sPW9RTje97EMAdtKzp3VglCl",
                            Phone = 364606406,
                            Picture = "logo.jpg",
                            StoreId = 1
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            PassWord = "10000:TNiDV9qnB0NNfj7QNsibY9PulzogVF8j9ANK3EUVae3D3VW5",
                            Phone = 364606406,
                            Picture = "logo.jpg",
                            StoreId = 2
                        });
