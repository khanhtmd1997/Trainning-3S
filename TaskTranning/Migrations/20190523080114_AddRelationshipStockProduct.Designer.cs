...
namespace TaskTranning.Migrations
{
    ...
    [Migration("20190523080114_AddRelationshipStockProduct")]
    partial class AddRelationshipStockProduct
    {
            ...
            modelBuilder.Entity("TaskTranning.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            PassWord = "10000:uSpD3pz/hUTlRRx+dQ0V5jgcJW+sXirCnNrl1wn0mUxYp5hb",
                            Phone = 364606406,
                            Picture = "logo.jpg",
                            StoreId = 1
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            PassWord = "10000:6VxjXal4jxXio3cswOa4YeEk4F3YQj3ghJvct0SAx3iS5o5g",
                            Phone = 364606406,
                            Picture = "logo.jpg",
                            StoreId = 2
                        });
