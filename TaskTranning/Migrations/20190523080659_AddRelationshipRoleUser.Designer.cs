...
namespace TaskTranning.Migrations
{
    ...
    [Migration("20190523080659_AddRelationshipRoleUser")]
    partial class AddRelationshipRoleUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskTranning.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TaskTranning.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            PassWord = "10000:hzAqdlm7tCsBbs7qMr0JHz8EtcaggsWMXeDip6wr0/RIBtOj",
                            Phone = 364606406,
                            Picture = "logo.jpg",
                            RoleId = 1,
                            StoreId = 1
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            PassWord = "10000:p0NYL/D5zot90lPzCfR1831h3OgS57zLv+MdrLhCsLEfQECO",
                            Phone = 364606406,
                            Picture = "logo.jpg",
                            RoleId = 2,
                            StoreId = 2
            ...
            modelBuilder.Entity("TaskTranning.Models.User", b =>
                {
                    b.HasOne("TaskTranning.Models.Role", "Role")
                        .WithMany("User")
